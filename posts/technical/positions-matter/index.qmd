...
description: "The Combine's Positional Variability in Predicting Career NFL Performance"
categories: [sports-analytics, python]
image: "./rb-plot-example.png"
draft: false
---

<!-- migrated from pelican: positions_matter.md -->
...
## Example Plot
<div>
<p style="text-align:center;"><img src="./rb-plot-example.png" alt="RB Plot Example" style="width: 72%; height: 72%></p>
</div>
