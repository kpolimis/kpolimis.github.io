...
description: "A workshop on gathering, processing, and analyzing Twitter API data with R, created for the 2016 Population Association of America Annual Meeting."
categories: [tutorial, python]
image: ""
draft: false
---

<!-- migrated from pelican: social_media_twitter_API_and_R.md -->
...
![Twitter-Main](./02-TwitterSignUp1.png)
<br>
...
![Dev-SignIn](./08-TwitterDevSignIn2.png)
...
![Twitter-App2](./10-TwitterCreateApp2.png)
<br>
...
![Twitter-Cred-1](./16-TwitterCred1.png)
...
![Clinton-tweets-map](./Clinton_tweets-map.png)
...
![Trump-tweets-map](./Trump_tweets-map.png)
...
![combined-tweets-map](./combined_tweets-map.png)<!-- -->
