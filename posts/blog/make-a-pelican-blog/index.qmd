...
description: "How to setup Pelican to build a blog with Travis-CI and deploy to GitHub Pages."
categories: [how-to]
image: "./pelican-quickstart.png"
draft: false
---

<!-- migrated from pelican: make-a-Pelican-blog.md -->
...
pelican-quickstart
~~~
![pelican-quickstart](./pelican-quickstart.png)
