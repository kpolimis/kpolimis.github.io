...
description: "I built this site on Pelican. I'm moving it to Quarto. Not because Pelican is bad (it's a good static site generator), but because if your brand is \"reproducible data science,\" your website should run code, not just describe it."
...
I built [kivanpolimis.com](kivanpolimis.com) on [Pelican](https://getpelican.com) in 2016. That was the right call then: Python-based, simple to configure, fast to deploy, Markdown-native. I've been writing posts on it for a decade.

I'm moving to [Quarto](https://quarto.org). This post explains why, what the migration looks like technically, and what I think it means for data scientists who maintain personal sites.
