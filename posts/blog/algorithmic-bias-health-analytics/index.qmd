...
description: "A widely deployed commercial algorithm systematically underestimated the health needs of Black patients, not because of malicious design, but because cost was used as a proxy for need. This is the story of what went wrong, why it went wrong, and how to build models that don't replicate structural inequity."
